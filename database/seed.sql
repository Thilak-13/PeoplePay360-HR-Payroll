...
(1, 'Aditya', 'Raman', 'aditya.raman@peoplepay360.local', '+91-98401-23456', 1, 2, 'Chief Executive Officer', '987654321001', 'HDFC0000004', '2022-01-10', 'active'),
(2, 'Rajesh', 'Swaminathan', 'rajesh.swaminathan@peoplepay360.local', '+91-98412-34567', 2, 1, 'Lead Systems Architect', '987654321002', 'HDFC0000004', '2022-03-15', 'active'),
(3, 'Priya', 'Sundaram', 'priya.sundaram@peoplepay360.local', '+91-94440-12345', 2, 1, 'Senior Software Engineer', '987654321003', 'SBIN0000800', '2022-06-01', 'active'),
(4, 'Karthik', 'Subramanian', 'karthik.subramanian@peoplepay360.local', '+91-98840-56789', 2, 1, 'Backend Platform Engineer', '987654321004', 'ICIC0000001', '2023-01-15', 'active'),
(5, 'Ananya', 'Krishnan', 'ananya.krishnan@peoplepay360.local', '+91-97909-12345', 2, 1, 'Frontend UI/UX Engineer', '987654321005', 'HDFC0000004', '2023-04-10', 'active'),
(6, 'Meenakshi', 'Sundaram', 'meenakshi.s@peoplepay360.local', '+91-98402-98765', 3, 1, 'Director of People & Culture', '987654321006', 'KKBK0000460', '2022-02-01', 'active'),
(7, 'Venkat', 'Raghavan', 'venkat.raghavan@peoplepay360.local', '+91-98413-87654', 3, 1, 'Talent Acquisition Lead', '987654321007', 'SBIN0000800', '2023-05-15', 'active'),
(8, 'Deepa', 'Natarajan', 'deepa.natarajan@peoplepay360.local', '+91-94441-76543', 3, 1, 'People Operations Specialist', '987654321008', 'ICIC0000001', '2023-09-01', 'active'),
(9, 'Sridhar', 'Balasubramanian', 'sridhar.b@peoplepay360.local', '+91-98841-65432', 4, 2, 'Chief Financial Officer', '987654321009', 'HDFC0000004', '2022-01-15', 'active'),
(10, 'Lavanya', 'Ramachandran', 'lavanya.r@peoplepay360.local', '+91-97910-54321', 4, 1, 'Senior Controller & Accountant', '987654321010', 'SBIN0000800', '2022-11-01', 'active'),
(11, 'Vignesh', 'Jayaraman', 'vignesh.j@peoplepay360.local', '+91-98403-43210', 4, 1, 'Payroll & Compliance Analyst', '987654321011', 'KKBK0000460', '2023-08-15', 'active'),
(12, 'Kavitha', 'Narayanan', 'kavitha.n@peoplepay360.local', '+91-98414-32109', 5, 2, 'VP of Sales & Growth', '987654321012', 'ICIC0000001', '2022-04-01', 'active'),
(13, 'Arvind', 'Parthasarathy', 'arvind.p@peoplepay360.local', '+91-94442-21098', 5, 1, 'Enterprise Account Executive', '987654321013', 'HDFC0000004', '2023-07-01', 'active'),
-- Two employees intentionally leaving bank_account_number and bank_ifsc NULL to test compliance alerts in demos
(14, 'Gautham', 'Vasudevan', 'gautham.v@peoplepay360.local', '+91-98842-10987', 2, 1, 'DevOps & Reliability Engineer', NULL, NULL, '2023-10-01', 'active'),
(15, 'Divya', 'Thirumalai', 'divya.t@peoplepay360.local', '+91-97911-09876', 5, 1, 'Growth Marketing Strategist', NULL, NULL, '2023-11-15', 'active')
ON CONFLICT (id) DO UPDATE SET
...
(7, 1, 'Professional Tax (Tamil Nadu - Chennai)', 'PTAX', 'DEDUCTION', 120, 'fixed', 0.00, 'GROSS'),
...
SELECT 
    ...
    CASE 
        ...
        WHEN r.code = 'PTAX' THEN CASE WHEN p.gross_wage >= 21000.00 THEN 200.00 ELSE 0.00 END
